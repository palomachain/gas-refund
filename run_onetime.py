from functions import get_refundlist, get_refundlist_byblock, conv_dt_rev
import sys
import os, datetime
...
if 1:
    refund_list = get_refundlist_byblock(contract='0x6D727250bd150A9dC006b65b6C7a0D817B02bB2e', methodid='0xeadf4af7', fromblock=15632154,toblock=15679648 )
    print(refund_list)
